...
```python
re.match(word_regex, "Hello world!")
```
...
Pass the pattern first, then the string.  
May return an iterator, a string or a match object.  
Write your regex patterns as a string preceded by `r`, so that it will be interpreted as a raw string, to prevent escaping of characters: `r"[a-z]"`, `r"\n"`
...
```
    ...
    {'you', 'SOLDIER', 'there', 'will', 'needs', 'its', 'under', 'Wait', 'Listen', 'an', 'non-migratory', 'may', 'sovereign', 'every', 'they', 'Are', 'forty-three', 'times', 'So', 'but', 'We', 'Yes', 'speak', 'be', 'he', 'husk', 'swallow', 'them', 'son', 'ounce', 'zone', 'point', 'lord', 'weight', 'yet', 'go', "'", 'get', 'other', 'order', 'strangers', 'warmer', 'wings', 'since', 'plover', 'the', "'m", 'must', 'interested', '2', 'coconut', 'coconuts', 'minute', 'with', 'A', 'beat', 'servant', 'tell', "'d", 'master', 'Saxons', "'ve", 'got', 'wants', 'using', 'course', 'carry', 'two', 'bangin', 'why', 'SCENE', ']', 'me', 'empty', 'ARTHUR', 'that', 'creeper', 'King', '#', 'court', 'and', 'winter', 'guiding', 'Well', 'Found', 'They', 'anyway', 'are', 'line', '!', 'a', '?', 'Oh', 'south', 'What', 'defeator', 'have', 'mean', 'could', 'strand', 'dorsal', 'this', '[', 'by', 'Halt', '1', 'Pendragon', 'Supposing', 'land', 'seek', 'KING', 'maybe', 'then', 'Who', 'Ridden', 'climes', 'bring', 'clop', 'feathers', 'not', ':', 'martin', 'question', 'air-speed', 'wind', 'European', 'fly', '--', "'s", 'Patsy', 'African', 'my', 'ridden', 'kingdom', ',', 'yeah', 'if', 'goes', 'castle', 'You', 'together', 'length', 'here', 'Court', 'of', 'agree', 'Will', 'our', 'halves', 'it', 'No', 'just', 'one', 'use', 'migrate', "'em", 'these', 'ratios', 'Pull', 'Where', 'back', 'knights', 'through', 'join', 'Camelot', 'England', 'trusty', 'temperate', 'pound', 'The', 'am', 'maintain', 'right', 'That', 'horse', 'is', 'search', 'tropical', 'Please', 'It', 'grip', 'Britons', 'But', '...', 'where', 'on', 'Am', "'re", 'in', 'covered', '.', 'Not', 'found', 'Mercea', 'carrying', 'grips', 'bird', 'do', 'swallows', 'Arthur', 'velocity', 'second', 'ask', 'five', 'at', 'sun', 'from', 'who', 'suggesting', 'Whoa', 'simple', "n't", 'snows', 'your', 'or', 'In', 'breadth', 'does', 'to', 'all', 'carried', 'matter', 'Uther', 'house', 'I', 'held'}
...
`re.match` will match from the beginning of the string until it cannot match any longer.
...
| pattern        | matches                         | example          |
|:---------------|:--------------------------------|------------------|
| `[A-Za-Z]+`    | upper and lowercase latin chars | 'ABCDEFghijk'    |
| `[0-9]`        | numbers from 0 to 9             | 9                |
| `[A-Za-Z\-\.]+`| upper/lower case, - and .       | 'My-Website.com' |
| `(a-z)`        | a, - and z                      | 'a-z'            |
| `(\s+\|,)`      | spaces or a comma               | ', '             |
...
pattern3 = r"(#\d\w+\?!)"
pattern4 = r"\s+"
print(regexp_tokenize(pattern1, my_string))
print(regexp_tokenize(pattern2, my_string))
print(regexp_tokenize(pattern3, my_string))
print(regexp_tokenize(pattern4, my_string))
...
print(regexp_tokenize(my_string, pattern2)) # AAAAaaahhh... jeez... thought I was going crazy!
```
...
![png](NLP_1-regex/output_44_0.png)
